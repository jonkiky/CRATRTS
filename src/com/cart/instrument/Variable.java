...
public class Variable {
	 ...
	 */
	private String getValue(Object value) throws Exception {
	 ...
	 *             When the type is unsupported.
	 */
	private String getValue(Object value, String type) throws Exception {
		if (value == null) {
			return "null";
		}
		...
		throw new Exception("Unhandled type when converting to trace file " + type);
	}
	 ...
	 */
	private String getArray(JSONArray array, String type) throws  Exception {
		String result = "[";
	...
	String getDeclaration() {
		...
		if (isArray()) {
			...
			varDecl.append("\t\tenclosing-var " + name + "\n");
		}
...
//			throw new CrawljaxException("Unhandled type: " + type);
	 ...
	 *             On error.
	 */
	public String getData(Object value) throws Exception{
